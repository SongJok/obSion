...
const NAV_ITEMS = [
  ...
  { id: "files" as const, label: "工作区文件", icon: Files },
  { id: "reports" as const, label: "工作区报告", icon: FileChartColumn },
  { id: "dashboards" as const, label: "工作区仪表盘", icon: LayoutDashboard },
  { id: "sql" as const, label: "工作区 SQL", icon: FileCode },
  { id: "evidence" as const, label: "工作区证据", icon: FileCheck2 },
  { id: "timeline" as const, label: "运行时间线", icon: History },
  { id: "knowledge" as const, label: "企业知识", icon: BookOpen },
  { id: "code" as const, label: "企业代码图", icon: Code2 },
  { id: "data" as const, label: "数据目录", icon: Database },
  { id: "studio" as const, label: "Studio 开发台", icon: PencilRuler },
  { id: "eval" as const, label: "评测台", icon: FlaskConical },
